...
plt_fits(image, wcs, figure=1, title="Sample Title", cmap='Greys_r', norm=LogNorm())
plt_fits(segm, wcs, figure=2, title="Sample Title", cmap=segm.cmap(random_state=12345), norm=None)
